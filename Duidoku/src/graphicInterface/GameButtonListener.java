...
/**
 * Clase que implementa una accion que se ejecutara cuando se aprete un boton en el tablero del juego
...
public class GameButtonListener implements ActionListener{
	 ...
	 * @param g el tablero de botones con el que representamos el juego
	 * @param vi la interfaz
	 */
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        for (int i = 0; i < 9 && !found; i++) {
        	for (int j = 0; j < 9 && !found; j++) {/*Buscamos el boton que llamo a la accion*/
        		...
        		if (found) {
        			v.optionScreen(i,j);/*Creamos una ventana on las opciones*/
                }
            }
        }
    }
