...
public class DuidokuProblem implements AdversarySearchProblem<DuidokuState> {
  ...
  */
   ...
   * @pre d != null
   * @param d : El estado dado : DuidokuState
   * @post initial == d
  */
  ...
  /**
    ...
    * @pre this != null
    * @return El estado inicial del juego : DuidokuState
  */
  @Override
   ...
   * @pre state != null
   * @return Una Lista con todos los sucesores validos de state : List<\DuidokuState\>
  ...
  */
   ...
   * @pre state != null
   * @param state : El estado que le pasaremos : DuidokuState
   * @return Si el estado es un estado final : boolean
  */
  @Override
   ...
   *     Utiliza 2 funciones, una para el inicio del juego(Que busca bloquear casillas) y otra 
   *     para la parte final(que busca que la cantidad de casillas en blanco sea par, 
   *     ademas de maximizar los conflictos).
   * @pre state != null
   * @param state : El estado a evaluar : DuidokuState
   * @return el valor asignado al estado : int
  */
  @Override
  ...
  /**
    * Retorna MinValue.
   * @return El atributo minValue : int
   */
  @Override
  public int minValue() {
    return minValue;
  ...
  /**
   * Retorna MaxValue.
   * @return El atributo maxValue : int 
  */
  @Override
  public int maxValue() {
    return maxValue;
